...
const Settings = () => {
  ...
  const themeOptions = [
    { value: 'light', label: 'Light', icon: Sun, description: 'Warm and bright appearance' },
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="text-center mb-12">
            ...
            >
              Customize your experience on Saranya Ice Creams
            </motion.p>
          </div>
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Customize how Saranya Ice Creams looks</p>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
                  <div>
                    <Label htmlFor="new-flavors" className="font-medium">New Flavors</Label>
                    <p className="text-sm text-muted-foreground">Be first to know about new flavors</p>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
                  <div>
                    <Label htmlFor="stock-alerts" className="font-medium">Stock Alerts</Label>
